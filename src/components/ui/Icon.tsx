...
export const ICON_PATHS = {
  ...
  services:
    'M11 12h2a2 2 0 1 0 0-4h-3c-.6 0-1.1.2-1.4.6L3 14M7 18l1.6-1.4c.3-.4.8-.6 1.4-.6h4c1.1 0 2.1-.4 2.8-1.2l4.6-4.4a2 2 0 0 0-2.8-2.9l-4.2 3.9M2 13l6 6',
  instructions:
  ...
  help: 'M2 12a10 10 0 1 0 20 0a10 10 0 1 0-20 0M9.1 9.3a3 3 0 0 1 5.83 1c0 2-3 3-3 3M12 17h.01',
