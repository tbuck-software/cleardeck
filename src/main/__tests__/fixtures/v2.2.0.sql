-- Synthetic v2.2.0 records from the release schema.
-- Source tag: v2.2.0 (773cd69f12e382baf1478f73085219ee7d4b9ada).
...
CREATE TABLE patients (
        ...
        note TEXT,
        createdAt TEXT DEFAULT (datetime('now'))
      , contact TEXT, admissionDate TEXT, cognitionImpaired INTEGER, mobilityImpaired INTEGER, hkpCode TEXT, intensiveCare TEXT, careLevel INTEGER, legacyQprStatus TEXT, serviceStatus TEXT NOT NULL DEFAULT 'active', serviceEndDate TEXT, serviceScope TEXT NOT NULL DEFAULT 'unknown', representativeStatus TEXT NOT NULL DEFAULT 'unknown', hkpCodes TEXT NOT NULL DEFAULT '[]', assessmentSource TEXT NOT NULL DEFAULT 'unknown', assessmentDate TEXT, assessmentNote TEXT, akiSetting TEXT, phkpFirst INTEGER NOT NULL DEFAULT 0, phkpStartDate TEXT, serviceScopeSource TEXT NOT NULL DEFAULT 'legacy');
INSERT INTO "patients" VALUES(1,'Upgrade Pflege','1948-09-12','Synthetisch','C','Altnotiz','2026-09-06 06:22:02',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'C','active',NULL,'unknown','unknown','[]','unknown',NULL,NULL,NULL,0,NULL,'services');
...
CREATE UNIQUE INDEX idx_service_definitions_name
        ON service_definitions(name COLLATE NOCASE);
CREATE INDEX idx_service_definitions_active
        ON service_definitions(active, sortOrder);
INSERT INTO "service_definitions" VALUES(1,'Große Grundpflege','s36-care',1,0,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(2,'Kleine Grundpflege','s36-care',1,1,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(3,'Große Grundpflege mit Lagern/Betten','s36-care',1,2,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(4,'Kleine Grundpflege mit Lagern/Betten','s36-care',1,3,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(5,'Ganzwaschung','s36-care',1,4,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(6,'Teilwaschung','s36-care',1,5,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(7,'Kleine pflegerische Hilfestellung 1','s36-care',1,6,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(8,'Kleine pflegerische Hilfestellung 2','s36-care',1,7,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(9,'Kleine pflegerische Hilfestellung 3','s36-care',1,8,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(10,'Kleine pflegerische Hilfestellung 4','s36-care',1,9,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(11,'Ausscheidungen','s36-care',1,10,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(12,'Mobilisation','s36-care',1,11,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(13,'Selbstständige Nahrungsaufnahme','s36-care',1,12,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(14,'Pflegerische Betreuung nach § 36 SGB XI','s36-support',1,13,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(15,'Verhinderungspflege nach § 39 SGB XI','s39-prevention',1,14,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(16,'Sonstige Behandlungspflege nach § 37 SGB V','s37-hkp',1,15,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(17,'Medizinische Kompressionsstrümpfe anziehen','s37-hkp',1,16,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(18,'Medizinische Kompressionsstrümpfe ausziehen','s37-hkp',1,17,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(19,'Medikamente richten / Medikamentenbox stellen','s37-hkp',1,18,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(20,'Medikamente verabreichen','s37-hkp',1,19,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(21,'Außerklinische Intensivpflege nach § 37c SGB V','s37c-aki',1,20,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(22,'Hilfe bei der Haushaltsführung nach SGB XI','household',1,21,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(23,'Betreuung oder Entlastung nach § 45a/45b SGB XI','relief',1,22,'2026-09-11 18:17:39');
INSERT INTO "service_definitions" VALUES(24,'Beratungsbesuch nach § 37 Abs. 3 SGB XI','s37-consultation',1,23,'2026-09-11 18:17:39');
...
CREATE INDEX idx_patient_services_definition
...
INSERT INTO "settings" VALUES('schema_version','23');
...
INSERT INTO "sqlite_sequence" VALUES('service_definitions',24);
COMMIT;
