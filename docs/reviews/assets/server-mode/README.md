...
Die Aufnahmen zeigen die vereinfachten Einstellungen aus `d3309bf` ohne zusätzliche Karten. Hinweise zur Übertragung und zum Rückwechsel erscheinen beim jeweiligen Schritt.

Die Aufnahmen zeigen:

- [01 – lokales Dashboard](01-local-dashboard.png)
- [02 – lokale Datenablage](02-local-settings.png)
- [03 – Erstübertragung mit leeren Zugangsfeldern](03-connection-empty.png)
- [04 – verbundener Editor](04-connected-editor.png)
- [05 – verbundener Reader](05-connected-reader.png)
- [06 – Bestätigung vor dem Rückwechsel zum lokalen Bestand](06-return-local.png)
