...
Mit einer synthetischen Testperson wurde der Fehler per Computer Use in der laufenden macOS-Demo reproduziert: Eintritt zunächst 01.03.2025, anschließend in der Historie auf 01.09.2024 korrigiert. Die Historie zeigte September, die Personenauswahl und ihr Formular enthielten weiterhin März. Im Kalender war „Vorherigen Monat anzeigen“ bei März 2025 deaktiviert. Damit ist ein Ablauf nachgewiesen, der das gemeldete Symptom erzeugt. Ob Ole genau diesen Ablauf verwendet hat, ist ohne seinen Bestand weiterhin unbekannt.
