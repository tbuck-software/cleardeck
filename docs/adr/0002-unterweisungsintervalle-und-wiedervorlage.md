...
**Dokumentationsstatus:** Umgesetzt in den Migrationen v015 und v016.
...
- 24 Monate bei der Ersthelfer-Fortbildung (DGUV V1 § 26 Abs. 3) und der Belehrung nach IfSG § 43 Abs. 4
- 6 Monate bei Beschäftigten unter 18 (JArbSchG § 29 Abs. 2)
...
Grund: In einer Prüfung ist der Unterschied entscheidend. Eine Zahl aus der Norm ist zu belegen, eine betriebliche Festlegung ist zu begründen. Ohne dieses Feld sind im Katalog beide nicht auseinanderzuhalten — genau das war die Ausgangslage, in der „IfSG / KRINKO" jahrelang als Grundlage der Hygieneunterweisung geführt wurde, obwohl sie aus dem Arbeitsschutzrecht folgt.

## 4. Unter 18 wird personenbezogen gedeckelt, nicht über das Intervall

JArbSchG § 29 Abs. 2 verkürzt auf halbjährlich, und zwar **für alle Themen dieser Person**, nicht für ein bestimmtes Thema. Ein Intervall an der Definition kann das nicht abbilden.

Entscheidung: Bei der Berechnung der nächsten Fälligkeit gilt `min(intervalMonths, 6)`, wenn die Person **am Tag der Durchführung** noch nicht 18 ist.

Maßgeblich ist bewusst der Durchführungstag und nicht der Fälligkeitstag: Die Norm verlangt die Wiederholung, *solange* die Person minderjährig ist. Bei einem Zwei-Jahres-Thema wäre eine sechzehnjährige Person am regulären Termin längst volljährig — eine Prüfung am Fälligkeitstag ließe sie also zwei Jahre ohne Unterweisung, genau die Lücke, die § 29 Abs. 2 schließen soll.
...
Grund: Der abgeschlossene Eintrag ist der Nachweis. Wer ihn weiterschiebt, verliert die Historie und kann in einer Prüfung nicht mehr zeigen, wann die vorherige Unterweisung stattgefunden hat. Ohne Intervall (`NULL`) entsteht kein Folgeeintrag.
...
## 7. Der Katalog ist ein Anspruch auf Vollständigkeit, kein Vorschlag

Entscheidung: Was nach heutigem Kenntnisstand hineingehört, steht drin. Die fünf von der Recherche benannten Pflichten sind mit v016 ergänzt.

Tragend ist, dass ein Katalogeintrag nur eine **Definition** ist. Fällig wird nichts, solange er niemandem zugeordnet ist. Ein Eintrag zu viel kostet also eine Zeile in einer Liste; ein fehlender Eintrag kostet einen Nachweis, an den niemand gedacht hat. Deshalb sind auch die Fälle enthalten, die nur auf manche Dienste zutreffen — die Belehrung nach IfSG § 43 gilt nur bei eigener Küche, das steht in der Notiz des Eintrags.
...
| --- | --- | --- |
| Hygieneunterweisung (jährlich) | `IfSG / KRINKO` | `BioStoffV § 14 / TRBA 250` — IfSG § 23 erfasst ambulante Pflegedienste nicht |
